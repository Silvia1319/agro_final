...
from domino_slicer import unpack_args
...
class Slicer(ABC):
    ...
    def fit(
        ...
        data_dp: pd.DataFrame = None,
    ) -> Slicer:
        raise NotImplementedError()

    @abstractmethod
    def transform(self, data_dp: pd.DataFrame) -> pd.DataFrame:
        raise NotImplementedError()
...
#            print(self.mm.y_hat_probs.shape,"YYYYYYYY",self.mm.y_hat_probs)
    ...
    def transform(
        ...
        # print("cluster_indices                ",self.slice_cluster_indices,"\n\n\n\clusters shape",clusters.shape)
        # print("**********************",clusters[:, self.slice_cluster_indices])
